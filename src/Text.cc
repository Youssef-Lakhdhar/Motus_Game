...
Text :: Text (sf::RenderWindow& window, const wstring text, const size_t x, const size_t y, const size_t character_size, const sf::Color& color, const string font, const bool bold, const bool italic, const bool underlined) {
